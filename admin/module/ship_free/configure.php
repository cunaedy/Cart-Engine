...
switch ($cmd) {
    case 'save':
        ...
        update_mod_config($mod_id, 'minimum', $minimum);
        admin_die('admin_ok');
    break;
    ...
    default:
        ...
        // init some stuffs
        $row['config_title'] = 'Shipping Module: Free Shipping';
        $row['mod_id'] = $mod_id;
        ...
        $items = array(
            ...
            array('config_label' => 'Minimum Purchase '.$lang['l_cur_name'], 'config_value' => create_varchar_form('minimum', $module_config[$mod_id]['minimum']))
        );
