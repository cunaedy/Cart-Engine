...
switch ($cmd) {
    ...
    default:
        ...
        // init some stuffs
        $row['config_title'] = 'Shipping Module: Per item';
        $row['mod_id'] = $mod_id;
        ...
        $items = array(
            ...
            array('config_label' => 'Fee per item '.$lang['l_cur_name'], 'config_value' => create_varchar_form('per_item', $module_config[$mod_id]['per_item']))
        );
