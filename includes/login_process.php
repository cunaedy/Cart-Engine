...
sql_query("UPDATE ".$db_prefix."orders SET user_id='$user_id' WHERE user_id='$current_user_id'");
sql_query("UPDATE ".$db_prefix."gift SET redeem_user_id='$user_id' WHERE redeem_user_id='$current_user_id'");
