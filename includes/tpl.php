...
function flush_tpl($mode = 'user', $subtpl = '')
{
    ...
    if ($mode == 'user') {
        ...
        $txt['please_purchase_license_to_support_us'] = base64_decode('WW91IGFyZSB1c2luZyB1bmxpY2Vuc2VkIHZlcnNpb24gb2YgQ2FydCBFbmdpbmUuIFBsZWFzZSBzdXBwb3J0IHVzIGJ5IDxhIGhyZWY9Imh0dHA6Ly93d3cuYzk3Lm5ldCI+cHVyY2hhc2luZyB0aGUgbGljZW5zZTwvYT4u');
