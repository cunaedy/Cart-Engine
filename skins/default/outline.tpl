		...
		<div id="navbar" class="navbar-collapse collapse">
			...
			<ul class="nav navbar-nav">
				<li class="dropdown">
					...
					{$l_my_cart}<span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="{$site_url}/checkout.php?summary=1" class="popiframe">{$l_mycart_text}</a></li>
						<li><a href="{$site_url}/checkout.php">Checkout</a></li>
					</ul>
				</li>
			</ul>

			<form method="get" action="{$site_url}/shop_search.php" class="navbar-form navbar-right">
