			...
			<div id="wrapper">
				<div class="sameH" id="nav-bar">
					...
					<ul id="accordion">
						...
						<!-- BEGINIF $current_admin_level >= 4 -->
						<li><a href="#"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Transactions</a>
							<ul>
								<li><a href="{$site_url}/{$l_admin_folder}/trx_list.php">List All</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/trx_list.php?filter_by=1">All Pending</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/trx_list.php?filter_by=2">All Processing</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/trx_list.php?filter_by=3">All Shipped</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/trx_list.php?filter_by=4">All Delivered</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/trx_list.php?filter_by=5">All Completed</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/trx_list.php?filter_by=6">All Cancelled</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/rev_report.php">Sales Reports</a></li>
							</ul>
						</li>
						<li><a href="#"><span class="glyphicon glyphicon-barcode" aria-hidden="true"></span> Products</a>
							<ul>
								<li><a href="{$site_url}/{$l_admin_folder}/product_list.php">Search</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/product.php?mode=new">Add New</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/product_cat.php">Category</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/product_cf.php">Custom Fields</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/edit_opt.php?fid=distro&clear_cache=everything">Brand/Manufacturer</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/quickedit.php">Quick Edit</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/cat_mover.php">Category Mover</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/menu_man.php?cmd=design&midx=7">Reorder Category</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/menu_man.php?cmd=design&midx=8">Reorder CF</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/bulk.php">Bulk Upload</a></li>
							</ul>
						</li>
						<li><a href="#"><span class="glyphicon glyphicon-bullhorn" aria-hidden="true"></span> Promotion</a>
							<ul>
								<li><a href="{$site_url}/{$l_admin_folder}/featured.php">Featured Products</a></li>
								<li><a href="{$site_url}/{$l_admin_folder}/coupon.php">Gift Coupon</a></li>
							</ul>
						</li>
						<!-- ENDIF -->
						...
						<!-- ENDIF -->
						<!-- BEGINIF $is_allowed_site_setting -->
										<li><a href="{$site_url}/{$l_admin_folder}/local_config.php">Shop Settings</a></li>
